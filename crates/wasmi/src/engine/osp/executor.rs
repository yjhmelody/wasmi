...
use accel_merkle::{keccak256, Bytes32, ProveData};
...
pub(super) struct OspExecutor<'a> {
    status: &'a mut OspStatus,
    call_stack: &'a mut CallStackProof,
...
struct EngineState<'a> {
    current_pc: u32,
    inst_root: &'a Bytes32,
    call_stack: &'a CallStackProof,
    value_stack: &'a ValueStackProof,

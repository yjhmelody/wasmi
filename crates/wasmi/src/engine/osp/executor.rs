...
pub(super) struct OspExecutor<'a, Hasher>
where
    Hasher: MerkleHasher,
{
    status: &'a mut OspStatus,
    ...
    extra: &'a mut ExtraProof<Hasher>,
}

// /// One instruction executor used for OSP.
// pub struct OspExecutor {
//     status: OspStatus,
...
// #[derive(Encode)]
// struct EngineState<'a, Hasher: MerkleHasher> {
//     current_pc: u32,
//     inst_root: &'a Bytes32,
//     call_stack: &'a CallStackProof<Hasher>,
//     value_stack: &'a ValueStackProof<Hasher>,
//     /// Generated by `ModuleState`.
//     module_state_root: &'a Bytes32,
//     _hasher: core::marker::PhantomData<Hasher>,
// }
//
// #[derive(Encode)]
// struct ModuleState<'a> {
//     globals_root: &'a Bytes32,
//     table_roots: &'a [Bytes32],
//     memory_roots: &'a [Bytes32],
// }

// impl<'a> ModuleState<'a> {
//     fn hash(&self) -> Bytes32 {
//         keccak256(&Encode::encode(self))
//     }
// }
...
impl<'a, Hasher: MerkleHasher> OspExecutor<'a, Hasher> {
    ...
    #[inline]
    fn set_status(&mut self, status: OspStatus) {
        *self.status = status;
    }

    #[inline]
    fn set_trapped(&mut self) -> Result<()> {
        self.set_status(OspStatus::Trapped);
        Ok(())
    }
